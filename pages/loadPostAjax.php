...
try{
  // Requête SQL pour aller chercher les articles à afficher de  plus quand on click sur voir plus
  $sql = "SELECT id_post, titre_post, description_post,date_post, nom_utilisateur, nom_categorie
      ...
      // connexion pour faire la request sql
      $result = $objConnMySQLi->query($sql);
      if($result == false) {
        ...
        if(mysqli_num_rows($result) > 0)
     	 {
     	      ...
     	      ';
            // renvoi des donner en ajax dans le data
     	      echo $output;
